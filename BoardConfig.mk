...
BOARD_KERNEL_CMDLINE := androidboot.hardware=qcom androidboot.selinux=permissive user_debug=31 debug ignore_loglevel batt_cap=2,4200,3330,3400 hack_lcd=1 chg_hack_lcd=0 pmemlog=3 reboot=2
